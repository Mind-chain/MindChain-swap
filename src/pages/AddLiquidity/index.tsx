...
import { Currency, currencyEquals, ETHER, TokenAmount, WETH } from 'versa-sdk';
...
export default function AddLiquidity({
  ...
  async function onAdd() {
    ...
    // Send the transaction with the specified gas limit and gas price
    await method(...args, {
      ...(value ? { value, gasLimit, gasPrice } : { gasLimit, gasPrice }),
    })
      .then((response) => {
